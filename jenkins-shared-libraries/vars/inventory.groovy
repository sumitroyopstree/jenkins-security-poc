...
def call(String type, String appName, String envName = 'TEST') {
    ...
    def cdData = [
        ...
        // NON-HEALTHCARE JOBS
        'Non-Healthcare-BE': [
            'TEST': [ip: '10.2.30.254', path: '/opt/non-healthcare-test/backend', app: 'non-healthcare-test-backend', ssh: 'Non-Healthcare-test-server', secret: 'arn:aws:secretsmanager:us-east-1:167121004129:secret:dev.nonhealthcare.com-kg1Ktx'],
